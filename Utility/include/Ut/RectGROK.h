...
namespace Ut
{
    ...
    public:
        ...
        [[nodiscard]] Vec<T, 2> topRight() const noexcept
        {
            return origin + size;
        }
        [[nodiscard]] Vec<T, 2> center() const noexcept
        {
            return origin + size * T(0.5);
        }
        ...
        // Setters
        void setOrigin(T x, T y) noexcept
        {
            origin = Vec<T, 2>(x, y);
        }
        void setSize(T width, T height) noexcept
        {
            size = Vec<T, 2>(width, height);
        }
